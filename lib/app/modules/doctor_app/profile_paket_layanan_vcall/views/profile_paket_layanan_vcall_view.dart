...
class ProfilePaketLayananVcallView
    extends GetView<ProfilePaketLayananVcallController> {
  const ProfilePaketLayananVcallView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(
            'Paket Layanan Video Call',
