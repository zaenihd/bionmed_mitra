...
class RegisterApotekerView extends GetView<RegisterController> {
   RegisterApotekerView({Key? key}) : super(key: key);
  final TextEditingController controllerName = TextEditingController();
  final TextEditingController controllerApoteker = TextEditingController();
      ...
      //   child: 
        ...
        ListView(
          ...
          children: [
            ...
            // ignore: avoid_unnecessary_containers
            InputPrimary(onChange: (p0) {}, controller: controllerApoteker, onTap: (){}, hintText: 'Masukkan nama apoteker',),
            const SizedBox(height: 16),
            const SizedBox(
              width: double.infinity,
              child: Text(
