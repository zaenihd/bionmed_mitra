                      ...
                      Obx(
                        () => controller.nursepaketData.isEmpty
                            ? Padding(
                                ...
                                child: Txt(text: 'Belum ada paket di buat'),
                              )
                            : Cntr(
                                // color: Colors.amber,
                                  ...
                                  itemBuilder: (context, index) => Cntr(
                                    ...
                                    child: Column(
                                      children: [
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      InputPrimary(
                                                                          ...
                                                                          onChange:
                                                                            ...
                                                                            controller.hargaCurrens.value =
                                                                                int.parse(controller.hargaPaketC.text.replaceAll(".", "")).toString();
                                                                      ...
                                                                      InkWell(
                                                                        onTap:
                                                                          ...
                                                                          for (var i = 0;
                                                                              i < controller.nursepaketData.length;
                                                                              i++) {
                                                                            // var item = items[i];
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Obx(
                                                                                () => controller.tampunganNurseId.isNotEmpty || controller.nursepaketData[index]['package_nurse_sops'] != []
                                                                                    ? Txt(text: controller.tampunganNurseId.isEmpty ? "${controller.nursepaketData[index]['package_nurse_sops'].length} Dipilih" : '${controller.tampunganNurseId.length} Dipilih')
                                                                                    : Txt(
                                                                                        text: 'Scope of Work',
                                                                        ...
                                                                        () => controller.tambahDiskon.isTrue
                                                                            ...
                                                                            : InkWell(
                                                                                ...
                                                                                child: Container(
                                                                                  width: Get.width,
                                                                                  height: 45,
                                                                                  decoration: DottedDecoration(shape: Shape.box, borderRadius: BorderRadius.circular(6), color: const Color(0xffCCCCCC)),
                                                                                  alignment: Alignment.center,
                                                                                  child: Row(
                                                                      ...
                                                                      Obx(
                                                                        () => controller.namaPaket.isEmpty &&
                                                                            ...
                                                                            ? ButtonPrimary(marginLeft: 0, marginRight: 0, title: 'Tambahkan', onPressed: () {})
                                                                            : ButtomGradient(
                                                                                margin: 0,
                                                                                label: 'Ubah Paket',
                                                                                onTap: () async {
                                        ...
                                        Cntr(
                                          onTap: () {
                                            Get.to(()=>  SowTimLayanan(data: controller.nursepaketData[index]['package_nurse_sops'],));
                                          },
                                          padding: const EdgeInsets.only(
                                              left: 10, right: 10),
                                          height: 45,
