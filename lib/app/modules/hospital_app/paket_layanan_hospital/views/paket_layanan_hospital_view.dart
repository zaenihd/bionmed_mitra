              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        myC.listServiceHospital[index]['team'].toString() == "[]" ?
                        const Icon(Icons.crisis_alert_outlined, color: Colors.yellow, size: 15,) : const Icon(Icons.check_circle, color: Colors.green, size: 15,),
                        const SizedBox(
                        width: 5.0,
                        ),
                        Txt(
                          text: myC.listServiceHospital[index]['team'].toString() == "[]" ? "Belum terdaftar" :'Layanan Terdaftar',
                          weight: medium,
                          size: 11,
                          color: Colors.grey,
                        ),
