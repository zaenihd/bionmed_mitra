...
class RegisterHospitalLanjutanView extends StatefulWidget {
  const RegisterHospitalLanjutanView({super.key});

  @override
  State<RegisterHospitalLanjutanView> createState() =>
      _RegisterHospitalLanjutanViewState();
}

class _RegisterHospitalLanjutanViewState
    extends State<RegisterHospitalLanjutanView> {
              ...
              children: [
                ...
                Container(
                    ...
                    child: Obx(() => ButtomGradient(
                        margin: 0,
                        label: myC.isLoading.isFalse ? "Simpan" : "Loading...",
                        onTap: () async {
