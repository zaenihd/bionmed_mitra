...
class DetailPendapatanTimHospital extends GetView<PendapatanTimHospitalController> {
  DetailPendapatanTimHospital({Key? key}) : super(key: key);
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => CardOrdeFromIncomerHospital(
                  ...
                  //         ['image'],
                  name: 
                  Get.find<LoginController>().role.value == "nurse" ? controller.detailIncomeFromDate[index]['nurse']['name'] :
                  controller.detailIncomeFromDate[index]['ambulance']['name'],
